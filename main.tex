...
Προβλεπόμενοι χρόνοι εκτέλεσης: Η λειτουργία\selectlanguage{english} polyval \selectlanguage{greek}χρησιμοποιήθηκε για τον υπολογισμό των προβλεπόμενων χρόνων εκτέλεσης για δύο σύνολα τιμών\selectlanguage{english} n:
...
Δημιουργεί έναν τετραγωνικό πίνακα A μεγέθους \selectlanguage{english}n×n \selectlanguage{greek}ρυθμίζοντας τη διαγώνιο, την κάτω διαγώνιο (μία κάτω από την κύρια διαγώνιο) και την άνω διαγώνιο (μία πάνω από την κύρια διαγώνιο) με τυχαίους ακέραιους αριθμούς μεταξύ 1 και 5. Ο πίνακας A σχηματίζεται στη συνέχεια αφαιρώντας την κάτω και την άνω διαγώνιο από την κύρια διαγώνιο.\\

Έλεγχος θετικής οριστικότητας:\\
Προσπαθεί να εκτελέσει μια αποσύνθεση\selectlanguage{english} Cholesky\selectlanguage{greek} στο 
...
Επίλυση συστήματος: \\
Η συνάρτηση αρχικοποιεί ένα διάνυσμα b με τυχαίους ακέραιους αριθμούς μεταξύ 1 και 10 και στη συνέχεια υπολογίζει έναν τροποποιημένο πίνακα συστήματος A1 και ένα τροποποιημένο διάνυσμα \selectlanguage{english}b1\selectlanguage{greek} της δεξιάς πλευράς. Αυτές οι τροποποιήσεις ενσωματώνουν αντίστροφες πράξεις στο \selectlanguage{english}D \selectlanguage{greek}και αλληλεπιδράσεις με τα\selectlanguage{english} L\selectlanguage{greek} και\selectlanguage{english} U.\selectlanguage{greek} Το σύστημα\selectlanguage{english} A1x=b1 \selectlanguage{greek}επιλύεται στη συνέχεια για το διάνυσμα\selectlanguage{english} x.\selectlanguage{greek}\\
...
Εμφάνιση αποτελεσμάτων: Η συνάρτηση εξάγει το διάνυσμα της λύσης\selectlanguage{english} x,\selectlanguage{greek} τον αρχικό πίνακα 
A, και τους τροποποιημένους πίνακες A1, A2 και A3.
Υπολογισμός και εμφάνιση προτύπων: Υπολογίζει τα \selectlanguage{english} 2-norms \selectlanguage{greek}της κύριας διαγωνίου του \selectlanguage{english}
D, \selectlanguage{greek}της υποδιαγωνίου του\selectlanguage{english} L\selectlanguage{greek} και της υπερδιαγωνίου του \selectlanguage{english}U\selectlanguage{greek} και εμφανίζει αυτές τις νόρμες.\\

Εκτίμηση υπολογιστικού κόστους για υποθετικά προϊόντα \selectlanguage{english}Hadamard:\selectlanguage{greek} \\
Παρέχει μια απλουστευμένη εκτίμηση του υπολογιστικού κόστους για την εκτέλεση προϊόντων \selectlanguage{english}Hadamard\selectlanguage{greek} (πολλαπλασιασμός κατά στοιχείο) μεταξύ του πίνακα \selectlanguage{english}
D\selectlanguage{greek} και του διανύσματος\selectlanguage{english} b, \selectlanguage{greek}και ομοίως για τα \selectlanguage{english}L , U \selectlanguage{greek}με το\selectlanguage{english} b,\selectlanguage{greek} υποθέτοντας ότι είναι δυνατές οι άμεσες πράξεις.
...
\subsection{\selectlanguage{english}\texttt{pcg\_1070263}}
% Insert your content here
\selectlanguage{greek}
Η συνάρτηση του MATLAB είναι μια τροποποιημένη έκδοση της μεθόδου\selectlanguage{english} Preconditioned Conjugate Gradients (PCG),\selectlanguage{greek} με την ονομασία\selectlanguage{english} \texttt{pcg\_1070263}.\selectlanguage{greek} Έχει σχεδιαστεί για την επίλυση ενός συστήματος γραμμικών εξισώσεων\selectlanguage{english} $Ax=b$ \selectlanguage{greek}με τη δυνατότητα χρήσης ενός προρυθμιστή.\\
...
Παρακολουθεί τη σύγκλιση συγκρίνοντας τη νόρμα του υπολείμματος \selectlanguage{english}\texttt{(normr\_act)} \selectlanguage{greek}με την καθορισμένη ανοχή \selectlanguage{english}(tol).\selectlanguage{greek}
...
% Insert your content here
\selectlanguage{greek}
Αυτός ο κώδικας επιλύει ένα γραμμικό σύστημα που ορίζεται από Τo μητρώο υπ’ αριθμ. 1 του \selectlanguage{english}SuiteSparse,\selectlanguage{greek} δηλ. το \texttt{1138\_bus} και το διάνυσμα της δεξιάς πλευράς\selectlanguage{english} b \selectlanguage{greek}χρησιμοποιώντας τη μέθοδο\selectlanguage{english} Preconditioned Conjugate Gradients (PCG) \selectlanguage{greek}με την τροποποιημένη συνάρτηση\selectlanguage{english} \texttt{(pcg\_1070263)}. \\
\selectlanguage{greek}
Ορισμός μητώου:\\
